  ...
  return (
    <Account>
      <div class="bgcolor">
        ...
        <div class="container">
          <div class= "">
            <h1 class="title pt-5 mt-5">Campus Coder</h1>
            <div class="my-5"></div>
            <div class="main-button px-4 py-2 mr-3">
              <a class="colorchange nav-link" href='#about'>About</a>
            </div>
            <div class="other-button px-4 py-2 mr-3">
              <a class="colorchange-black nav-link" href="#how">How Does it Work?</a>
            </div>
          ...
          <h2 class="customh2" id="how">How Does it Work?</h2>
