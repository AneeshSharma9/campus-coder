    ...
    return (
        <Account>
            <div class="bgcolor">
                ...
                <h2 class="customh2 text-center" id="how">
                    How Does it Work?
                </h2>
                <p class="introtext">
                ...
                <div class="faq-list">
                    <div class="faq expand">
                        <div class="faq-q">
                            <h3>How does Campus Coder ensure the quality of work delivered by students?</h3>
                        </div>
                        <div class="faq-a">
                            <p>We maintain a rigorous selection process for our student developers, ensuring they possess the necessary skills and expertise. Additionally, we encourage businesses to provide feedback on the projects, and our team offers support and guidance throughout the development process.</p>
                        </div>
                    </div>
                    <div class="faq expand">
                        <div class="faq-q">
                            <h3>What types of projects can I request on Campus Coder?</h3>
                        </div>
                        <div class="faq-a">
                            <p>Campus Coder offers a wide range of services, including website development, automation scripts, and tackling small tasks. Whatever your tech-related needs are, our talented students are eager to take on the challenge.</p>
                        </div>
                    </div>
                    <div class="faq expand">
                        <div class="faq-q">
                            <h3>How are projects priced on Campus Coder?</h3>
                        </div>
                        <div class="faq-a">
                            <p>Projects on Campus Coder are priced at a fraction of the cost of professional services. The exact pricing depends on the complexity and scope of the project. Our aim is to provide affordable solutions for small businesses while ensuring fair compensation for the students' efforts.</p>
                        </div>
                    </div>
                    <div class="faq expand">
                        <div class="faq-q">
                            <h3>Can I hire a student developer for a long-term project?</h3>
                        </div>
                        <div class="faq-a">
                            <p>Absolutely! Campus Coder welcomes both short-term and long-term projects. Whether you need a one-time task or ongoing development support, our students are ready to collaborate according to your project requirements.</p>
                        </div>
                    </div>
                </div>
            </div>
